...
export const TOOL_SERVICES: Record<string, string[]> = {
    ...
    nova_canvas_generate: ["agentcore_gateway", "lambda", "bedrock_nova", "s3"],
    nova_canvas_edit: ["agentcore_gateway", "lambda", "bedrock_nova", "s3"],
    nova_canvas_history: ["agentcore_gateway", "lambda", "s3"],
    nova_reel_generate: ["agentcore_gateway", "lambda", "bedrock_nova", "s3"],
    nova_reel_status: ["agentcore_gateway", "lambda"],
    nova_reel_history: ["agentcore_gateway", "lambda", "s3"],
