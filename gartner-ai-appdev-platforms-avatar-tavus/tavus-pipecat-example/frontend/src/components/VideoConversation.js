...
// Content items matching the backend definitions (prompts/<event>/config.yaml)
const CONTENT_ITEMS = {
  services_overview: {
    url: '/content/bank-services',
    label: 'Lone Star Global Bank — Services',
  },
  personal_banking: {
    url: '/content/personal-banking',
    label: 'Checking, Savings & Account Opening',
  },
  wealth_investments: {
    url: '/content/wealth-investments',
    label: 'Retirement & Global Investments',
  },
  fraud_security: {
    url: '/content/fraud-security',
    label: 'Fraud Detection & Account Security',
  },
};
      ...
      <div className="start-screen">
        ...
        <div className="start-inner">
          <header className="start-header">
            <div>
              <p className="eyebrow">{({'aws-summit-sydney-2026':'AWS Summit Sydney 2026','aws-summit-bengaluru-2026':'AWS Summit Bengaluru 2026','aws-summit-mumbai-2026':'AWS Summit Mumbai 2026','aws-gartner-ai-platform-2026':'AWS Gartner Demo'})[process.env.REACT_APP_EVENT_CONFIG] || 'AWS Gartner Demo'}</p>
