...
| `gateway_nova_canvas_generate` / `_edit` / `_history`            | Image generation / editing / session history.                                                                                                        |
| `gateway_nova_reel_generate` / `_status` / `_history`            | Video generation / status / history.                                                                                                                 |
