...
These instructions will get you started developing with the starter kit, assuming your demo has already been [created](./demo-creation.md), you have already [set up](./demo-setup.md) the project, and are ready to contribute!
